  ...
  QWidget(parent), ui(new Ui::ChatWindow)
{
  ...
  //Обновление сообщений на экране
...
void ChatWindow::handleServerResponse_GetUsersList()
{
  ...
  //Экран входа пользователей в чат
  QDialog listUsersDialog(this);
  listUsersDialog.setModal(true); //Активно только это окно
...
{
  //Есть новые сообщения - обновите сообщения на экране
  //Общие сообщения
